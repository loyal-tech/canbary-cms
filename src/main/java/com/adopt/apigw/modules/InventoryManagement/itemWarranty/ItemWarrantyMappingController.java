...
public class ItemWarrantyMappingController extends ExBaseAbstractController<ItemWarrantyMappingDto> {
    ...
    @Override
    public GenericDataDTO save(@Valid @RequestBody ItemWarrantyMappingDto entityDTO, BindingResult result, Authentication authentication, HttpServletRequest req,@RequestParam Integer mvnoId) throws Exception {
