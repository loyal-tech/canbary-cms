...
public class CustomerRenewalMessage {
    ...
    public CustomerRenewalMessage(String username,String countryCode, String  mobileNumber, String emailId,Integer mvnoId, String message, TemplateNotification template, String sourceName, String plan, String purchaseType, Long buId,Long staffId) {
