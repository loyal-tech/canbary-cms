...
public class SendFollowUpRemarkMsg {
    ...
    public SendFollowUpRemarkMsg(String parentMobileNumber, String parentEmailId, String message, TemplateNotification template, String parentStaffPersonName, String staffPersonName, String remark, Integer mvnoId, String ticketNumber, String teamStaff,Long buId,Long staffId) {
