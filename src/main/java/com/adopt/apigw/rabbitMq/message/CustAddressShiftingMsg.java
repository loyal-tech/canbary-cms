...
public class CustAddressShiftingMsg {
    ...
    public CustAddressShiftingMsg(String username, String  mobileNumber, String emailId, String status, Integer mvnoId, String message, TemplateNotification template, String sourceName,Long buId,Long staffId,String custtype,Integer custId){
        ...
        customerData.put("custId",custId);
