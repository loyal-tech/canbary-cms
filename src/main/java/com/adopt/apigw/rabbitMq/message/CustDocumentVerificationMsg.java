...
public class CustDocumentVerificationMsg {
    ...
    public CustDocumentVerificationMsg(String username, String  mobileNumber, String emailId, String status, Integer mvnoId, String message, TemplateNotification template, String sourceName,Long buId,Long staffId){
