...
public class CustTicketCloseMsg {
    ...
    public CustTicketCloseMsg(String username, String  mobileNumber, String emailId, String status, Integer mvnoId, String caseNumber, String message, TemplateNotification template, String sourceName,Long buId,Long staffId ){
