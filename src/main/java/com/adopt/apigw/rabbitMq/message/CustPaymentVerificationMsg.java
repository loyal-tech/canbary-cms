...
public class CustPaymentVerificationMsg {
    ...
    public CustPaymentVerificationMsg(String username, String  mobileNumber, String emailId, String status, Integer mvnoId, String reciptNo, Double paymentAmount, String paymentDate, String message, TemplateNotification template, String sourceName,Long buId,Long staffId,String custtype){
